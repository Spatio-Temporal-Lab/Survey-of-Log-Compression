...
TYPE = []
TYPE.append(dataset_name)
# , "Healthapp", "Hpc", "Linux", "Mac", "Proxifier", "Spark", "Ssh", "Zookeeper"
# TYPE = ["Thunderbird"]
# TYPE = ["Android", "Apache", "Bgl", "Hadoop", "Hdfs", "Healthapp", "Hpc", "Linux", "Mac", "Openstack", "Proxifier",
#  "Spark", "Ssh", "Thunderbird", "Windows", "Zookeeper"]
...
def procFiles(filename, file_list, fileBeginNo, fileEndNo, now_input, now_output, isPadding):
    ...
    for i in range(fileBeginNo, fileEndNo + 1):
        ...
        if(not os.path.exists(now_input)):
            ...
            continue
        order = "./THULR -I " + now_input + " -O " + now_output + " -Z zip"
...
if __name__ == "__main__":
    ...
    output_path = "../../../scripts/com_output/loggrep_Z/"
