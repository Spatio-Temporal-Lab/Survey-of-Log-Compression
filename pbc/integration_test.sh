...
${PBC_HOME}/bin/pbc --train-pattern -i ${PBC_INTEGRATION_TEST_DIR}/test_data -p ${PBC_INTEGRATION_TEST_DIR}/test_data_2000_100_pbc_lz4 --compress-method pbc_lz4 --pattern-size 100 --train-data-number 2000 --train-thread-num 64 >> ${TRAIN_PATTERN_LOG} 2>&1
...
${PBC_HOME}/bin/pbc --test-compress -i ${PBC_INTEGRATION_TEST_DIR}/test_data -p ${PBC_INTEGRATION_TEST_DIR}/test_data_2000_100_pbc_lz4 --compress-method pbc_lz4 >> ${TEST_COMPRESS_LOG} 2>&1

# run compress file and decompress file
${PBC_HOME}/bin/pbc -c -i ${PBC_INTEGRATION_TEST_DIR}/test_data -p ${PBC_INTEGRATION_TEST_DIR}/test_data_2000_100_pbc_lz4 -o ${PBC_INTEGRATION_TEST_DIR}/test_data_2000_100_pbc_lz4_compress >> ${COMPRESS_LOG} 2>&1
${PBC_HOME}/bin/pbc -d -i ${PBC_INTEGRATION_TEST_DIR}/test_data_2000_100_pbc_lz4_compress -p ${PBC_INTEGRATION_TEST_DIR}/test_data_2000_100_pbc_lz4 -o ${PBC_INTEGRATION_TEST_DIR}/test_data_2000_100_pbc_lz4_decompress >> ${DECOMPRESS_LOG} 2>&1

cat ${PBC_INTEGRATION_TEST_DIR}/test_data | ${PBC_HOME}/bin/pbc -c -p ${PBC_INTEGRATION_TEST_DIR}/test_data_2000_100_pbc_lz4 | gzip -c | gzip -c -d | ${PBC_HOME}/bin/pbc -d -p ${PBC_INTEGRATION_TEST_DIR}/test_data_2000_100_pbc_lz4 -o ${PBC_INTEGRATION_TEST_DIR}/test_data_2000_100_pbc_lz4_decompress2

# compare the original file with the file after compression and decompression.
cmp ${PBC_INTEGRATION_TEST_DIR}/test_data ${PBC_INTEGRATION_TEST_DIR}/test_data_2000_100_pbc_lz4_decompress
cmp ${PBC_INTEGRATION_TEST_DIR}/test_data ${PBC_INTEGRATION_TEST_DIR}/test_data_2000_100_pbc_lz4_decompress2
