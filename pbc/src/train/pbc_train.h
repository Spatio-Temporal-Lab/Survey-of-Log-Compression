...
private:
    ...
    // Create lz4 dict using compressed data of train data compressed by pbc_only
    bool CreateLz4DictUsingCompressedData(char* pattern_buffer, int64_t& pattern_len);

    // Create secondary encoder(fse, fsst, zstd, lz4) data
